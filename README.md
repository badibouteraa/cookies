...
Install **angular-universal-cookies** from npm:

```bash
npm install angular-universal-cookies --save
```
...
import { BrowserCookiesModule } from 'angular-universal-cookies/browser';
...
...
import { ServerCookiesModule } from 'angular-universal-cookies/server';
...
import { AppModule } from './app/app.module';
import { AppComponent } from './app/app.component';
...
...
Then just import `CookiesService` from `angular-universal-cookies` and use it:

```ts
import { Component, OnInit } from '@angular/core';
import { CookiesService } from 'angular-universal-cookies';
...
import {
  ...
  CookiesOptions
} from 'angular-universal-cookies';
